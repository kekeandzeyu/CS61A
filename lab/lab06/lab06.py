class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            ...
            # Alternate way to write the above line: 
            # msg = '{} {}->{}'.format(msg, self.before, self.after)
            # msg = f'{msg} {self.before}->{self.after}'
...
class Server:
    ...
    def register_client(self, client):
        ...
        # A dictionary from client names to client objects
