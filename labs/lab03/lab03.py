...
def print_if(s, f):
    ...
    # Python will implicitly return None if no return statement is reached
...
def squares(s):
    ...
    # The above implementation is bad because it compares two floating points 
    # which may have rounding errors!
